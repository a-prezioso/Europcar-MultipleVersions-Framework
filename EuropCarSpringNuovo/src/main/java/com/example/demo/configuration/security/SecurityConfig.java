...
//	};
	...
	protected void configure(final HttpSecurity http) throws Exception
	{
		...
		.antMatchers("/SelezioneAnno/ListaAnni").hasAnyRole("ANONYMOUS", "USER")
		.antMatchers("/Budget/Lista/**").hasAuthority("ROLE_ADMIN")
		.antMatchers("/menu/List/**").hasAuthority("ROLE_USER")
		.antMatchers("/AliquotaIva/ListaAliquoteIva/**").hasAuthority("ROLE_USER")
		.and()
			.formLogin()

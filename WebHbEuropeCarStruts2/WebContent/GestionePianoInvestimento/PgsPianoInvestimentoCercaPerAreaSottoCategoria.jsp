...
<title>PgsPianoInvestimentoCercaPerAreaSottoCategoria</title>
	...
	<s:form action="ListaPianiAction" theme="simple">
		...
		<div align="center">
			...
			<tr>
				...
				<td><s:property value="#session.listasottocat.sottocategoria"/> </td>
				<s:hidden name="idsottocategoria" value="#session.listasottocat.idsottocategoria"></s:hidden>
			</tr>
			</table>
			<s:select label="SpesaInvestimento" name="idspesainvestimento" list="#session.listaspeseinv" value="%{#session.oggetto.ospesainvestimento.idspesainvestimento}"/>

					<s:submit align="center" method="cercaPerAreaSottoCategoriaSpesaInv" value="cerca"></s:submit>
					<table border="1">
			<tr>

...
<title>PgsPianoInvestimentoCercaPerAreaSottoCategoriaSpesaInv</title>
	...
	<s:form action="ListaPianiAction" theme="simple">
		...
		<div align="center">
			...
			<tr>
				...
				<td><s:property value="#session.listaspeseinv.spesainvestimento"/> </td>
				<s:hidden name="idspesainvestimento" value="#session.listaspeseinv.idspesainvestimento"></s:hidden>
			</tr>
			</table>

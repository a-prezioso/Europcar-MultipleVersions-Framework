...
<html>
<head>
<title>PgsElencoFatturaPerPreventivo.jsp</title>
</head>
...
<body>
	<s:form action="PreventivoFatAct" theme="simple">
		...
		<div align="center">
			...
			<s:submit align="center" action="PreventivoFatAct" value="indietro" />
			...
			<div align="center">
				<table border="1">
					...
					<s:iterator begin="#varInizio" end="#varFine"
						...
						<tr>
							<td><s:property
									value="ofatturapassiva.ofornitore.ragionesociale" /></td>

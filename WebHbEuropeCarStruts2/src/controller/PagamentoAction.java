...
public class PagamentoAction extends ActionSupport implements SessionAware {
	...
	private HashMap<String, String> map = new HashMap<String, String> () 
			{
		{
			put("GestioneRedirect", "Gestione Pagamenti e Distine");
			put("GenerazioneRedirect", "Generazione Distinte");

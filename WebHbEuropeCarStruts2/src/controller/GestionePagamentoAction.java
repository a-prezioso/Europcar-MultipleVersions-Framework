...
public class GestionePagamentoAction extends ActionSupport implements SessionAware {
	...
	private HashMap<String, String> map = new HashMap<String, String>() {
		{
			put("PagamentoRedirect", "Pagamento Fatture");
			put("RicercaRedirect", "Ricerca Distinte di Pagamento");

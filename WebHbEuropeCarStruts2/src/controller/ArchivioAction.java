...
public class ArchivioAction extends ActionSupport implements SessionAware {
	...
	private HashMap<String, String> map = new HashMap<String, String>() {
		{
			put("SottoCategoriaRedirect", "Archivio SottoCategoria");
			put("FornitoreRedirect", "Archivio Fornitore");
			put("ProgettoRedirect", "Archivio Progetto");
			put("AliquotaIvaRedirect", "Archivio Aliquota Iva");
			put("AreaInvestimentoRedirect", "Archivio Area Investimento");
			put("AreaRedirect", "Gestione Area Geografica");
			put("AziendaRedirect", "Gestione Azienda");
			put("GruppoRedirect", "Archivio Gruppo");
		}
	};

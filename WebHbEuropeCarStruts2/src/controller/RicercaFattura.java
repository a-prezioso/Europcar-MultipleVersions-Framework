...
public class RicercaFattura extends ActionSupport implements SessionAware {
	...
	private HashMap<String, String> map = new HashMap<String, String>() {
		{
			put("SottoCategoriaFatRedirect", "SottoCategoria");
			put("FornitoreFatRedirect", "Fornitore");
			put("PreventivoFatRedirect", "Preventivo");
		}
	};

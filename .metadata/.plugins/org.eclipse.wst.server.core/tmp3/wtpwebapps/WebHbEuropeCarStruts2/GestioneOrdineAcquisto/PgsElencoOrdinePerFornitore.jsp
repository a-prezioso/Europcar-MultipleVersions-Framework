...
<html>
<head>
<title>PgsElencoOrdinePerFornitore.jsp</title>
</head>
...
<body>
	<s:form action="FornitoreOrdAct" theme="simple">
		<div align="center">
			...
			<s:submit align="left" action="FornitoreOrdAct" value="Indietro" />
			...
			<div align="center">
				<table border="1">
					...
					<s:iterator begin="#varInizio" end="#varFine"
						value="#session.listaordini">
						<tr>
							<td><s:property value="ospesainvestimento.spesainvestimento" />
							</td>
							<td><s:property
									value="ospesainvestimento.osottocategoria.sottocategoria" /></td>
